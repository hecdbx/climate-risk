...
# MAGIC CREATE WIDGET TEXT demo_location DEFAULT 'San Francisco, CA';
# MAGIC CREATE WIDGET TEXT demo_latitude DEFAULT '37.7749';
# MAGIC CREATE WIDGET TEXT demo_longitude DEFAULT '-122.4194';
